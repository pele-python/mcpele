...
#
print "\n\nrunning cmake"
cmake_build_dir = os.path.abspath("build/cmake/")
cmake_install_dir = os.path.abspath("build/cmake/dest")
cwd = os.getcwd()
#os.chdir("build/cmake")
p = subprocess.call(["cmake", "../../source"],
                     cwd="build/cmake/")
p = subprocess.call(["make", "-j8", "install"],
                     cwd="build/cmake/")
...
cmake_libs = ["mcpele_lib", "pele_lib"]
...
depends_all = depends_mcpele + depends_pele + cmake_libs
...
cxx_modules = [
    Extension("mcpele.monte_carlo._pele_mc", 
              ...
              libraries=cmake_libs, library_dirs=[cmake_install_dir],
              ),
